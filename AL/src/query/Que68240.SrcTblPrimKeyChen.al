query 68240 "Src. Tbl. Prim. Key Chen."
{
    Caption = 'Src. Tbl. Prim. Key Change';
        ...
        dataitem(ADV_Version_Comparison; "Version Comparison")
        {
            ...
            dataitem(ADV_Compare_Table_Result; "Compare Table Result")
            {
                ...
                dataitem(ADV_Compare_Field_Result; "Compare Field Result")
                {
                    ...
                    {
                        DataItemLink = "Table Version Code" = ADV_Version_Comparison."Source Version Code", "Table No." = ADV_Compare_Field_Result."Table No.", "Field No." = ADV_Compare_Field_Result."Field No.";
                        SqlJoinType = InnerJoin;
